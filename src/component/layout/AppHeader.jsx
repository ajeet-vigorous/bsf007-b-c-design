  ...
  const fetchDomainSetting = () => {
    ...
    dispatch(getDomainSettingData(domainSetting)).then((res) => {
      if (!res?.error) {
        ...
        localStorage.setItem("clientdomainSetting", JSON.stringify(domainData));
      }
    });
  };
          ...
          <div className="flex justify-between items-center mx-auto w-full py-0">
            <div className="flex justify-start items-center py-3 gap-2">
              ...
              <div
                ...
                className="text-white block lg:hidden !md:w-[80px] !h-[15px]"
              >
                <img
                  className="text-white !w-[20px] min-w-[20px] !h-[15px]"
                  src="/images/zetto/menu.png"
                  alt=""
                />
              </div>
              {settings.domainName == "ons3" ? (
                <img
                  onClick={() => {
                    navigate("/dashboard");
                  }}
                  src={settings.logo}
                  className="h-[3rem] md:h-[50px] md:w-28 w-28  cursor-pointer"
                />
              ) : (
                <img
                  onClick={() => {
                  ...
                  src={settings.logo}
                  className="h-[3rem] md:h-[50px] md:w-52 w-48  cursor-pointer"
                />
              )}
            </div>
            {token ? (
                      ...
                      <div className="flex gap-2 justify-end w-full">
                        <ul className="flex gap-3 justify-end  items-start mb-0 ps-0 w-100 ">
                          ...
                          <li className="flex flex-col justify-center items-center md:gap-1">
                            ...
                            <div className="text-[var(--secondary)] md:hidden block text-[11px]">
                              B:{" "}
                          ...
                          <li className="relative hidden lg:block cursor-pointer">
                            ...
                            >
                              <img
                                ...
                                src="/images/zetto/profile.png"
                                alt=""
                              />
                              <img
                                className="absolute top-0 -right-[8px] !w-[17px] !h-[30px]"
                                src="/images/zetto/flash.png"
                                alt=""
                              />
                            </div>
                            {isOpen && (
                              <div className="fixed inset-0 z-50">
                                ...
                                >
                                  ...
                                  <div className="flex-1 capitalize text-sm text-[#212529] px-4">
                                    ...
                                    >
                                      <img
                                        src="/images/zetto/editpassword.webp"
                                        className="w-4 h-4"
                                      />
                                      <span className="text-[14px]">
                                        Change Password
                                    ...
                                    >
                                      <img
                                        src="/images/zetto/accstatement.webp"
                                        className="w-4 h-4"
                                      />
                                      <span className="text-[14px]">
                                        Account Statement
                                    ...
                                    >
                                      <img
                                        src="/images/zetto/bethistory.webp"
                                        className="w-4 h-4"
                                      />
                                      <span className="text-[14px]">
                                        Current Bets
                                    ...
                                    >
                                      <img
                                        src="/images/zetto/profloss.webp"
                                        className="w-4 h-4"
                                      />
                                      <span className="text-[14px]">
                                        Profit/Loss
                                    ...
                                    >
                                      <img
                                        src="/images/zetto/passhistory.webp"
                                        className="w-4 h-4"
                                      />
                                      <span className="text-[14px]">
                                        Activity Log
