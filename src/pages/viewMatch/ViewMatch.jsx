                    ...
                    <div className="">
                        <div className="xl:block hidden">
                            ...
                            <div className="bg-[var(--primary)] flex justify-between px-2">
                                <div className="text-sm font-semibold uppercase text-white flex items-center py-2">{inplayMatch?.matchName}</div>
                            </div>
                        </div>
        ...
        <div className="details">
          <div className="w-full relative md:text-sm text-[10px]">
            ...
            >
              ...
              {fullscreen ? <IoMdArrowDropup size={30} color="orange" /> : <IoMdArrowDropdown size={30} color="orange"/>}
            </span>
            <iframe
            ...
            />
                                ...
                                <div>
                                    {inplayMatch.isTv ? <>
                                        {selectedType  && <div className="bg-white w-full h-48">
                                            <div className="details">
                                                <div className={`w-full relative md:text-sm text-[10px]`}>
                        ...
                        <div class="flex w-full md:w-full overflow-hidden py-2 md:py-1 md:px-0 my-1">
                         ...
                         {inplayMatch?.sportId == 4 &&   <div className="w-full inline-flex overflow-auto hide-scrollbar">
        ...
        {inplayMatch?.isFancy && inplayMatch?.sportId === 4 && (
          ...
          >
            Fancy
                        ...
                        {inplayMatch.sportId != 4 &&<OtherMarketsComponent
                            activeTab={activeTab}
                                                ...
                                                <table className="min-w-full capitalize border border-[#f8f8f8]">
                                                    <thead>
                                                        <tr className="w-full text-black/80 text-[12px] uppercase font-[400] bg-[#ffffff] text-left border border-[#f8f8f8]">
                                                            <th className="px-[6px] py-1 border border-[#f8f8f8] whitespace-nowrap">Market</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        {/* Unsettle Bets */}
                                                        <div className="bg-[var(--primary)] flex justify-between px-2">
                                                            <div className="text-xs md:flex hidden font-light text-white items-center py-2">{inplayMatch?.matchName}</div>
    ...
    >
      <GiTv size={30} className="text-[var(--primary)]" />
              ...
              {/* <div  className='fixed  bottom-20 right-[25px] cursor-pointer w-[60px] h-[60px] bg-[var(--primary)] border-2 border-[var(--primary)]  rounded-full flex items-center justify-center animate-bounce z-50'> */}
                    <GiTv size={40} className="text-white fixed bg-[#FF5F1F] rounded-md p-1 bottom-20 right-[25px] animate-bounce " onClick={() => setSelectedType(prev => !prev)}/>
                {/* </div> */}
        </div >
    );
};
