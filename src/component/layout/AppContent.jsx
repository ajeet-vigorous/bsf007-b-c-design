...
import Aura from "../../pages/allCasino/Aura";
...
const AppContent = () => {
  return (
    <Routes>
      ...
      <Route
        path="/sport-view/:marketId?/:eventId?/:sportId?"
        element={<ViewMatches />}
      />
      <Route
        path="/sport-view-racing/:marketId?/:eventId?/:sportId?"
        element={<ViewMatchRacing />}
      />
      <Route path="/faq" element={<Faq />} />
      <Route path="/all-casino" element={<AllCasino />} />
      <Route
        path="/casino-list-by-providername/:providername?"
        element={<CasinoListByProviderName />}
      />
      ...
      <Route
        path="/ledger-casino-details/:eventId?/:ledgerType?/:date?"
        element={<LedgerCasinoDetails />}
      />
      <Route
        path="/international-ledger-casino-details/:eventId?/:ledgerType?/:date?"
        element={<InternationalLedgerDetails />}
      />

      <Route path="/casino" element={<AllGamesCasino />} />
      <Route path="/casino/aura" element={<Aura />} />
